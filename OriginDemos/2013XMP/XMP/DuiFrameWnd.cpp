...
CControlUI* CDuiFrameWnd::CreateControl( LPCTSTR pstrClassName )
{
    ...
    else if (_tcsicmp(pstrClassName, _T("WndMediaDisplay")) == 0)
    {
        ...
        HWND   hWnd = CreateWindow(_T("#32770"), _T("WndMediaDisplay"), WS_VISIBLE | WS_CHILD| WS_CLIPSIBLINGS | WS_CLIPCHILDREN, 0, 0, 0, 0, m_PaintManager.GetPaintWindow(), (HMENU)0, NULL, NULL);
        pUI->Attach(hWnd);  
        return pUI;
    }
